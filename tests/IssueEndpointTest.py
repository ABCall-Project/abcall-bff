...
class IssueViewTestCase(unittest.TestCase):
    ...
    @patch('flaskr.service.IssueService.get_answer_ai')
    ...
    @patch('flaskr.service.IssueService.get_issues_dashboard')
    ...
    @patch('flaskr.service.IssueService.get_ia_predictive_answer')
